...
func (c *taskClient) GetTask(ctx context.Context, in *TaskRequest, opts ...grpc.CallOption) (*TaskReply, error) {
	out := new(TaskReply)
...
func (UnimplementedTaskServer) GetTask(context.Context, *TaskRequest) (*TaskReply, error) {
